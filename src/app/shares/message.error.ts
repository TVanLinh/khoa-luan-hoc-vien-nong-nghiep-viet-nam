export class MessageError {
  ...
  guild = "Chưa chọn phường xã";
  street = "Chưa nhập  đường thôn";
  nation = "Chưa chọn dân tộc ";
  placeRegisterHouseHold = "Chưa nhập hộ khẩu thường chú z ";
  bloodGroup = "Chưa chọn nhóm máu ";
}
